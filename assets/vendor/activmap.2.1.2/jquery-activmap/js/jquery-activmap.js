        ...
        activmap : function(settings){
            ...
            var _init = function(){
                ...
                $.each(s.places, function(i, place){
                    ...
                    if(place.address != undefined && place.address != '') mycontent += '<div class="activmap-address mt-2 mb-3">'+place.address+'</div>';
                    if(place.email != undefined && place.email != '') mycontent += '<a class="btn btn-success btn-sm w-100 mb-2 text-decoration-none text-white" href="mailto:'+place.email+'"><i class="far fa-envelope"></i> Enviar email</a>';
                    if(place.phone != undefined && place.phone != '') mycontent += '<a class="btn btn-success w-100 btn-sm mb-2 text-decoration-none text-white" href="tel:'+place.phone+'"><i class="fas fa-phone"></i> Ligar</a>';
                    if(place.whatsapp != undefined && place.whatsapp != '') mycontent += '<a class="btn btn-success btn-sm w-100 mb-2 text-decoration-none text-white" href="https://api.whatsapp.com/send?phone=+55'+place.whatsapp+'&text=Olá, quero adquirir os produtos da Hobety" target="_blank"><i class="fab fa-whatsapp"></i> Whatsapp</a>';
                    ...
                    google.maps.event.addListener(infoWindow[i], 'mouseout', function(){
                    ...
                    place.html = '<div class="activmap-place" id="activmap-place_'+i+'"><h3>'+place.title+'</h3><p>'+place.address+'</p><p id="distancia_'+i+'" style="display:none; font-weight:bold;"></p><input type="hidden" class="geolocalizacao" value="'+place.lat+':'+place.lng+':'+i+'" /></div>';
                ...
                $(document).on('mouseover', '.activmap-place', function(){
            ...
            var _update_places_tag = function(input, uncheck){
                ...
                $('#activmap-results-num').html(num_places+' Resultado(s)');
            }
